...
cc-factory has no single implementation language yet — these rules apply to any
code in the repo, whether a helper script, a hook, or a config file. Match the
idioms of the file you're in, then the module.
